...
<li>Κωστοπούλου Άννα (2025) {{% staticref "ptixiakes/2025.Anna.Costopoulou.pdf" "newtab" %}}Συμπεριφορά καταναλωτή ως προς τα δύσμορφα φρούτα και λαχανικά{{% /staticref %}}.  (Βαθμολόγηση: 10). (Βαθμολόγηση: )</li>
<li>Κιασούρη Αμαλία (2025) Συμπεριφορά καταναλωτή για τρόφιμα με σήμανση καθαρής ετικέτας. (Βαθμολόγηση: ) </li>
