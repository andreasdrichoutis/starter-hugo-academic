...
<ol>
    ...
    <li> Αμοιρίδου Θεοδώρα (2022) {{% staticref "ptixiakes/2022.Amoiridou.pdf" "newtab" %}}Στάσεις, απόψεις και προθυμία πληρωμής των καταναλωτών για οίνους παλαιωμένους στον πυθμένα της θάλασσας{{% /staticref %}}.  (Βαθμολόγηση: ) </li>
	 <li> Χρονοπούλου Βασιλική (2022) {{% staticref "ptixiakes/2022.Chronopoulou.pdf" "newtab" %}}Η επίδραση του ανθρωπομορφισμού στις στάσεις, αντιλήψεις και προθυμία πληρωμής των καταναλωτών για προϊόντα τροφίμων{{% /staticref %}}.  (Βαθμολόγηση: ) </li>
