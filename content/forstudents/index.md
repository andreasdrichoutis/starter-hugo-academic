...
<li>Πετρόπουλος Σταμάτιος (2025) Μελέτη της στάσης, των αντιλήψεων και της συμπεριφοράς των καταναλωτών για το Κίτρου Νάξου. (Βαθμολόγηση: ) </li>
...
<li>Μπλουγούρα Ασπασία (2025) Η επίδραση αφηγηματικών ιστοριών (storytelling) στην καταναλωτική συμπεριφορά κατά την επιλογή τροφίμων. (Βαθμολόγηση: )</li>
<li>Βούλγαρη Ελένη (2025) Η επίδραση της ψυχολογικής τιμολόγησης στην αντίληψη και την αγοραστική συμπεριφορά των καταναλωτών. (Βαθμολόγηση: )</li>
</ol>
</div>
