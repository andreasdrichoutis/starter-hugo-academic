...
<div class="year-section">
	...
	<ol class="item-list">
<li>Χρήστου Ανδριάννα (2025) Το φαινόμενο της αγκύρωσης και της χρονικής πίεσης κατά την επιλογή τροφίμων. (Βαθμολόγηση: 10)</li>
<li>Κωστοπούλου Άννα (2025) {{% staticref "ptixiakes/2025.Anna.Costopoulou.pdf" "newtab" %}}Συμπεριφορά καταναλωτή ως προς τα δύσμορφα φρούτα και λαχανικά{{% /staticref %}}. (Βαθμολόγηση: 10)</li>
<li>Κιασούρη Αμαλία (2025) {{% staticref "ptixiakes/2025.Amalia.Kiasouri.pdf" "newtab" %}}Συμπεριφορά καταναλωτή για τρόφιμα με σήμανση καθαρής ετικέτας{{% /staticref %}}. (Βαθμολόγηση: 10) </li>
<li>Πετρόπουλος Σταμάτιος (2025) Μελέτη της στάσης, των αντιλήψεων και της συμπεριφοράς των καταναλωτών για το Κίτρου Νάξου. (Βαθμολόγηση: 9.5) </li>
<li>Καλογεροπούλου Σταυρούλα (2025) <a href="https://kalligeneia.aua.gr/items/84afa7dc-9682-4240-8de4-dba5ab34da29" target="_blank" rel="noopener">Η αντίληψη των καταναλωτών για τις πρακτικές στους τομείς περιβάλλοντος, κοινωνίας και διακυβέρνησης των επιχειρήσεων (ESG): Συγκριτική ανάλυση και οι επιπτώσεις του «πράσινου ξεπλύματος» (Greenwashing) στην εμπιστοσύνη.</a> (Βαθμολόγηση: 10)</li>
<li>Μπλουγούρα Ασπασία (2025) <a href="https://kalligeneia.aua.gr/items/2d82aff6-8c0e-4f6a-9714-d572325b9cc9" target="_blank" rel="noopener">Η επίδραση αφηγηματικών ιστοριών (storytelling) στην καταναλωτική συμπεριφορά κατά την επιλογή τροφίμων.</a> (Βαθμολόγηση: 10)</li>
<li>Βούλγαρη Ελένη (2025) Η επίδραση της ψυχολογικής τιμολόγησης στην αντίληψη και την αγοραστική συμπεριφορά των καταναλωτών. (Βαθμολόγηση: 10)</li>
</ol>
</div>
...
<div class="year-section">
	...
	<ol class="item-list">
<li>Μπάλλα Ελπίδα (2024) Συμπεριφορά καταναλωτή ως προς την κατανάλωση κρέατος. (Βαθμολόγηση: )</li>
<li>Αναγνωστόπουλος Φοίβος (2024) Συμπεριφορά καταναλωτή ως προς τις χάρτινες συσκευασίες αναψυκτικών. (Βαθμολόγηση: 9.5)</li>
<li>Πάτσου Αντιγόνη (2024) Διερεύνηση προτιμήσεων και προθυμίας πληρωμής Ευρωπαίων καταναλωτών για premium συσκευασίες Ελληνικού εξαιρετικού παρθένου ελαιόλαδου. (Βαθμολόγηση: 10)</li>
<li>Κορακίτη Μαρία (2024) Επίδραση ανθρωπομορφικών παραγόντων στις στάσεις, συμπεριφορά και προθυμίας πληρωμής των καταναλωτών για προϊόντα τροφίμων. (Βαθμολόγηση: 10)</li>
<li> Δημούλη Ιωάννα (2024) Έρευνα συμπεριφοράς καταναλωτή σχετικά με βιώσιμες συσκευασίες ιχθύοπροϊόντων. (Βαθμολόγηση: 9) </li>
</ol>
</div>
