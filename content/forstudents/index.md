...
<ol>
    ...
    <li> Αμοιρίδου Θεοδώρα (2022) {{% staticref "ptixiakes/2022.Amoiridou.pdf" "newtab" %}}Στάσεις, απόψεις και προθυμία πληρωμής των καταναλωτών για οίνους παλαιωμένους στον πυθμένα της θάλασσας{{% /staticref %}}.  (Βαθμολόγηση: 10) </li>
	 <li> Χρονοπούλου Βασιλική (2022) {{% staticref "ptixiakes/2022.Chronopoulou.pdf" "newtab" %}}Η επίδραση του ανθρωπομορφισμού στις στάσεις, αντιλήψεις και προθυμία πληρωμής των καταναλωτών για προϊόντα τροφίμων{{% /staticref %}}.  (Βαθμολόγηση: 10) </li>
	 <li>Δουκέρη Δήμητρα-Γλυκερία (2021) {{% staticref "ptixiakes/2022.Doukeri.pdf" "newtab" %}}Προσδιοριστικοί παράγοντες αγοράς προϊόντων από διαδικτυακά καταστήματα πριν και μετά την καραντίνα εν μέσω της πανδημίας COVID-19{{% /staticref %}}.  (Βαθμολόγηση: 10)</li>
</ol>
