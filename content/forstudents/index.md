...
<ol>
    ...
    <li>Δουκέρη Δήμητρα-Γλυκερία (2021) {{% staticref "ptixiakes/2021.Doukeri.pdf" "newtab" %}}Προσδιοριστικοί παράγοντες αγοράς προϊόντων από διαδικτυακά καταστήματα πριν και μετά την καραντίνα εν μέσω της πανδημίας COVID-19{{% /staticref %}}.  (Βαθμολόγηση: )</li>
</ol>
